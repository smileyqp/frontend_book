...
#### ⭐️就是最好的鼓励哦wink～💗
  ...
  * [4.27复盘](#427--)
      ...
      - [js的数据类型](#js-----)
      - [判断数据类型的几种方式](#-----------)
  * [4.28 Study](#428-study)
      - [堆栈内存、闭包作用域](#----------)
      - [对象和数组的深浅拷贝](#----------)
      - [面向对象](#----)
      - [同步异步EventLoop](#----eventloop)
  * [4.29](#429)
      - [Vue&React](#vue-react)
      - [跨域问题的解决方案和实现原理](#--------------)
      - [Vue/React框架中关于组件信息通信引发的面试题](#vue-react-----------------)
      - [算法](#--)
        * [数组去重](#----)
  * [5.7](#57)
      - [算法复习](#----)
        ...
        * [字节跳动经典算法题](#---------)
  * [5.8](#58)
      - [1、call和apply区别是什么，哪个性能更好一些？](#1-call-apply---------------)
      - [2、编写一条正则，用来验证此规则：一个6～16位的字符串，必须同时包含有大小写字母和数字](#2------------------6-16---------------------)
      - [3、实现一个$attr(name, value)遍历，属性名为name，值为value的的元素合集](#3------attr-name--value--------name---value------)
      - [4、英文字母汉字组成的字符串，用正则给英文单词前后加上空格](#4----------------------------)
      - [5、实现`(5).add(3).minus(2)`使其输出结果为6](#5-----5-add-3-minus-2---------6)
      - [6、箭头函数和普通函数的区别](#6-------------)
  * [5.10](#510)
      - [7、字符串中字母大写转小写，小写转大写](#7------------------)
      - [8、实现字符串查找](#8--------)
      - [9、验证输入的是否是一个正确的网址](#9----------------)
  * [5.11](#511)
      - [10、 原型链](#10-----)
  ...
  * [5.12](#512)
      ...
      - [17、闭包](#17---)
      - [18、匿名函数](#18-----)
      - [18、`var a = ?`使得`a==1&&a==2&&a==3`](#18--var-a--------a--1--a--2--a--3-)
        * [`==`&`===`](#----------)
        * [`var a = ?`使得`a==1&&a==2&&a==3`](#-var-a--------a--1--a--2--a--3-)
  * [5.13](#513)
      - [19、对象调用push方法](#19-----push--)
      - [20、对象转数组](#20------)
          + [基本的数组相关的方法![](https://img-blog.csdnimg.cn/20210513160853638.png)](#--------------https---img-blogcsdnimgcn-20210513160853638png-)
      - [21、值类型&引用类型（变量类型）](#21---------------)
      - [22、typeof运算符（变量类型）和深拷贝](#22-typeof-------------)
        * [深拷贝](#---)
      - [23、变量计算、类型转换](#23----------)
        * [字符串拼接](#-----)
        * [==](#--)
        * [if语句和逻辑运算(if语句判断的就是truely变量和falsely变量)](#if--------if-------truely---falsely---)
        * [逻辑判断（也是truely变量和falsely变量）](#-------truely---falsely---)
  * [5.14](#514)
      - [24、class和继承](#24-class---)
        * [继承](#--)
      ...
      - [27、this](#27-this)
        * [this取什么:值是在函数执行的时候决定的不是在函数定义的时候确定的](#this------------------------------)
        * [手写bind函数](#--bind--)
        * [闭包的应用](#-----)
  * [5.16](#516)
      - [28、同步和异步](#28------)
...
- [JS Web API](#js-web-api)
  + [JS WEB API范围](#js-web-api--)
  * [5.17](#517)
      - [1、DOM操作（Document Object Model文档对象模型的集合）](#1-dom---document-object-model----------)
        * [题目](#---1)
        * [知识点](#----2)
      - [2、BOM操作（Browser Object Model）](#2-bom---browser-object-model-)
        * [知识点](#----3)
        * [navigator和screen](#navigator-screen)
        * [location和history](#location-history)
      - [3、事件](#3---)
        * [题目：](#---)
